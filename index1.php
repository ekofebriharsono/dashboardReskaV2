...
if(isset($_GET['lokasi'])){
  ...
  // include 'proses/koneksi_all.php';
  $isAll = true;
} else {
...
if(isset($_GET['tanggal_start']) && isset($_GET['tanggal_end'])){
  ...
  if($_GET['tanggal_start'] !='' && $_GET['tanggal_end'] !='' ){
    ...
    $sqlPendapatan = "select waktu_in, SUM(biayatotal) as biayatotal from t_parkir where waktu_in = '$dateNow' GROUP BY waktu_in";
    $sqlMotor = "select sum(biayatotal) as totalParkirMotor from t_parkir where status = 'S' and waktu_in = '$dateNow'";
    $sqlMobil = "select sum(biayatotal) as totalParkirMobil from t_parkir where status = 'B' and waktu_in = '$dateNow'";
    $sqlTotMotor = "select count(*) as totalParkirMotor from t_parkir where status = 'S' and waktu_in = '$dateNow'";
    $sqlTotMobil = "select count(*) as totalParkirMobil from t_parkir where status = 'B' and waktu_in = '$dateNow'";
    $sqlShift1Casual = "select sum(jumlah_casual) as casual from t_setorankasir where kode_shift = '1' and tanggal = '$dateNow'";
    $sqlShift1Manual = "select sum(jumlah_manualtiket) as manual from t_setorankasir where kode_shift = '1' and tanggal = '$dateNow'";
    $sqlShift2Casual = "select sum(jumlah_casual) as casual from t_setorankasir where kode_shift = '2' and tanggal = '$dateNow'";
    $sqlShift2Manual = "select sum(jumlah_manualtiket) as manual from t_setorankasir where kode_shift = '2' and tanggal = '$dateNow'";
    $sqlShift3Casual = "select sum(jumlah_casual) as casual from t_setorankasir where kode_shift = '3' and tanggal = '$dateNow'";
    $sqlShift3Manual = "select sum(jumlah_manualtiket) as manual from t_setorankasir where kode_shift = '3' and tanggal = '$dateNow'";
    $sqlMasalah = "select * from t_setorankasir where tanggal = '$dateNow' GROUP BY tanggal";
    $sqlKendaraanMasukPerjam = "select * from t_parkir where waktu_in = '$dateNow'";
